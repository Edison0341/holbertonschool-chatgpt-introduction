...
class Minesweeper:
    ...
    def check_win(self):
        ...
        # Number of revealed non-mine cells
        ...
        # If the number of revealed non-mine cells is equal to total non-mine cells, the player wins
        return revealed_non_mines == (total_cells - total_mines)
